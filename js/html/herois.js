...
function content(classe, selecionarHeroi){
  ...
  {
    let img = builder.element('img', {src: 'https://drive.google.com/uc?export=download&id='+classe.heroes[i].imgurl, draggable:"false", height: '100%', width: '100%', class:'card-img'}, []);
