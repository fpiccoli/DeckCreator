...
module.exports = {
  items(buttons){
    ...
    function montaJson(button, index, array){
      ...
      childs.push(builder.element('img', {src:'../img/icons/icon/'+button.icon, height:'50%', width:'25%', class:'center-icon-menu'}, []));
      childs.push(builder.element('img', {src:'../img/icons/bg/'+button.bg, height:'50%', width:'25%'}, []));
