...
describe("valida() -> verifica a existência de pastas e cria se necessario ->", function(){
  ...
  describe("deve verificar a arvore de pastas, nao criar nova pasta e devolver a string do caminho ->", function(){
    beforeEach(function(){
      os = jasmine.createSpyObj('os', ['homedir', 'platform']);
      os.homedir.and.returnValue('C:/User/username');
      os.platform.and.returnValue('win32');
  ...
  describe("deve verificar a arvore de pastas, criar as pastas e devolver a string do caminho ->", function(){
    beforeEach(function(){
      os = jasmine.createSpyObj('os', ['homedir', 'platform']);
      os.homedir.and.returnValue('C:/User/username');
      os.platform.and.returnValue('win32');
